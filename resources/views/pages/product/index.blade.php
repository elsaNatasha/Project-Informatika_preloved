                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center">
                                @if ($product->isFavorite)
                                    <a href="{{ route('favorites.index') }}" type="button" class="btn btn-danger btn-sm mx-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-title="Barang sudah ditambahkan ke favorite">
...
@push('css')
    ...
    <style>
        .card {
            ...
            max-width: 200px;
            /* Maksimal lebar kartu lebih kecil */
            margin: auto;
        }
        ...
        .card-body {
            padding: 8px;
            /* Mengecilkan padding body kartu */
        }
